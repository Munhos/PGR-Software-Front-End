...
export default function SideMenu() {
    ...
    return (
        ...
        >
            ...
            <i onClick={changeShowSideMenu} className={`bi bi-list ${styles.iconHideMenu}`}></i>
...

            {
                showSideMenu ? (
                    <>
                        <Link className={styles.link2} href="/termosdeuso">Termos de Uso</Link>
                        <Link className={styles.link2} href="/politicasdeprivacidade">Políticas de Privacidade</Link>
                    </>
                ) : null
            }
