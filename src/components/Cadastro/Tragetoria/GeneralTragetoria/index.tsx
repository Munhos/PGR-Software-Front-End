...
export default function TragetoriaComponent() {
    return (
        <div>
            <div className={styles.mainContainerOptions}>
                ...
                <Link href="/cadastros/tragetoria/novatragetoria">
                    <ButtonAdd
                        title="Cadastro de Tragetória"
                    />
                </Link>
            ...
            <TableComponent
                ...
                route="/cadastros/tragetoria/editartragetoria/"
            />
        </div>
    );
}
