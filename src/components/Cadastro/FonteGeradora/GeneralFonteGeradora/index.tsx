...
export default function FontegeradoraComponent() {
    return (
        <div>
            <div className={styles.mainContainerOptions}>
                ...
                <Link href="/cadastros/fontegeradora/novafontegeradora">
                    <ButtonAdd
                        title="Cadastro de Fonte Geradora"
                    />
                </Link>
            ...
            <TableComponent
                ...
                route="/cadastros/fontegeradora/editarfontegeradora/"
            />
        </div>
    );
}
